...
<template>
  <div id="publicacion">
    ...
    <div @click="mostrar" id="inicial">
      <img :src="ruta" :class="isCover ? 'cover' : 'normal'" ref="foto"/>
    </div>
    <div class="footer-publicacion" v-if="(windowWidth < 1100)">
      <h2 class="tematica">{{ tematica }}</h2>
    </div>
    <div id="final" v-if="mostrarFinal" @click="cerrar">
      <div id="contenido" @click.stop>
        <div id="imagen">
          <img :src="ruta" />
        </div>
        <div id="cuerpo">
          <div id="cerrar"><font-awesome-icon :icon="['fas', 'xmark']" @click="cerrar" /></div>
